...
public class MapCameraActivity extends AppCompatActivity implements View.OnClickListener ,LocationAssistant.Listener{


    private static final String TAG = "MapCameraActivity";
...
//------------------------------------------------------- initExtra ----------------------------------------------------------------------------------------------------------------------
    ...
    private void initExtra() {
        ...
        project_id = intent.getStringExtra(PASS_PROJECT_ID);
        work_id    = intent.getStringExtra(PASS_WORK_ID);
        Log.e(TAG, "Camera Lat: "+ cameraLat +" Camera Long: " + cameraLon +" ProjectID: " + project_id + " WorkID: "+ work_id);
    }
...
//------------------------------------------------------- Camera Submit ----------------------------------------------------------------------------------------------------------------------
    ...
    private void saveToLocalDatabase()
    {
        ...
        dataBaseHelper.insertMapImage(user_id,project_id,work_id,desc,cameraLat,cameraLon,imageDatetime, URL_Utility.APP_VERSION, destFile.getAbsolutePath(),destFile.getName());
        dataBaseHelper.insertMapImageLocal(user_id,project_id,work_id,desc,cameraLat,cameraLon,imageDatetime, URL_Utility.APP_VERSION, destFile.getAbsolutePath(),destFile.getName());
        imageDatetime = "";
        cameraLat = "";
        cameraLon = "";
        project_id = "";
...
//------------------------------------------------------- Image Upload ------------------------------------------------------------
    ...
    private void imageUpload() {
        ...
        progressDialog.show();
        new MapCameraActivity.FileUploadToServe().execute();
    }
