...
public class GISLayersActivity extends AppCompatActivity implements LocationAssistant.Listener {
...
//------------------------------------------------------------ on Create ---------------------------------------------------------------------------------------------------------------------
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gislayers);
        // Tool Bar
...
//------------------------------------------------------------ Bind Data ---------------------------------------------------------------------------------------------------------------------
    ...
    private void bindData() {
        ...
        listLayers = dataBaseHelper.getGISSurveyLayersList(Utility.getSavedData(this, Utility.GIS_SURVEY_WORK_ID), false);
        setAdapter();
    }
...
//------------------------------------------------------------ Set Adapter ---------------------------------------------------------------------------------------------------------------------
    ...
    private void setAdapter() {
        ...
        adapter = new AdapterLayerList(this, layerModels, () -> isDataChanged = true);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId() == android.R.id.home) {
            if (isDataChanged && listLayers.size() > 0) {
                setResult(RESULT_OK);
                dataBaseHelper.updateGISSurveyLayersData(listLayers);
            }
            finish();
            return true;
        }
