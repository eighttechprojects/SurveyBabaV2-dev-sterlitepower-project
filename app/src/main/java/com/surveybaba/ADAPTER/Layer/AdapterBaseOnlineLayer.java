...
public class AdapterBaseOnlineLayer extends RecyclerView.Adapter<AdapterBaseOnlineLayer.ViewHolder> {
...
//------------------------------------------------------------ Constructor ---------------------------------------------------------------------------------------------------------------------
    ...
    public AdapterBaseOnlineLayer(Activity context, List<ProjectLayerModel> list, AdapterLayerList.onItemClick onItemClick) {
