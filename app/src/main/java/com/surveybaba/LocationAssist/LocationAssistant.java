package com.surveybaba.LocationAssist;
...
//    public static final long REQUEST_LOCATION_UPDATE_INTERVAL = 1 * 60 * 1000;
    public static final long REQUEST_LOCATION_UPDATE_INTERVAL = 0;
    public static final long REQUEST_LOCATION_UPDATE_INTERVAL_FAST = 0;
//    public static final long REQUEST_LOCATION_UPDATE_INTERVAL_FAST = 30 * 1000;
    public static final long REQUEST_LOCATION_MIN_DISTANCE = 0;
    ...
    public void requestAndPossiblyExplainLocationPermission() {
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(activity, Manifest.permission.ACCESS_FINE_LOCATION) && listener != null)
    ...
    private void checkMockLocations() {
        ...
        if (Build.VERSION.SDK_INT < 18 && !Settings.Secure.getString(context.getContentResolver(), Settings.Secure.ALLOW_MOCK_LOCATION).equals("0")) {
    ...
    private void requestLocation() {
        ...
        locationRequest.setInterval(REQUEST_LOCATION_UPDATE_INTERVAL);
        locationRequest.setFastestInterval(REQUEST_LOCATION_UPDATE_INTERVAL_FAST);

        LocationSettingsRequest.Builder builder = new LocationSettingsRequest.Builder()
                .addLocationRequest(locationRequest);
        builder.setAlwaysShow(true);
        LocationServices.SettingsApi.checkLocationSettings(googleApiClient, builder.build()).setResultCallback(onLocationSettingsReceived);
    }
    ...
    public void onConnectionSuspended(int i) {
        Log.e("ASSISTANT", "onConnectionSuspended "+i);
    }
